# Hola 👋, soy Damián Muñoz

Soy Técnico Superior en **Desarrollo de Aplicaciones Web** 🖥️ en Zaragoza, España.

<hr style="height:6px; background-color:#333; border:none; border-radius:4px;">
...
- Desarrollo web con **React** ⚛️ y **Typescript** 🟦
- **Python** 🐍 para **Data Science** 📊 y **Machine Learning** 🧠
- Machine Learning con **TensorFlow** 🧩
- Desarrollo de agentes de IA y automatización con **n8n** 🤖
- Gestión y desarrollo de tiendas online e ecommerce con **Prestashop** 🛍️🐧
